...
import './index.css';
import ChildReact from './ChildReact';

class ChildReactCustomElement extends HTMLElement {
  ...
  mount() {
    const propTypes = ChildReact.propTypes ? ChildReact.propTypes : {};
    const events = ChildReact.propTypes ? ChildReact.propTypes : {};
    const props = {
      ...this.getProps(this.attributes, propTypes),
      ...this.getEvents(events),
      children: this.parseHtmlToReact(this.innerHTML)
    };
    render(<ChildReact {...props} />, this);
  }
...
customElements.define('child-react', ChildReactCustomElement);